'''	Sonador data models and collections for working with remote objects.
	Remote objects contain a "server" reference which points to the source
	of the remote data.
'''
...
from .local import SonadorCachedObjectCollectionMixin
...
class SonadorObjectCollection(SonadorCachedObjectCollectionMixin, GuruObjectCollection):
	'''	Collection of Sonador objects
	'''
	model = SonadorBaseObject

	def __init__(self, *args, **kwargs):
		''' Initialize Sonador collection and lookup cache
		'''
